...
class Angajat{
    ...
    public:
        ...
        //dar in fiecare face ceva diferit, insa are acelasi nume si acelasi scop
...
int main(){
    ...
    if(optiune==4){
        ...
        //Daca voiau si pentru IT (pentru ca difera impozitul) se copia "for-ul" si se punea "salariu_brut_IT"
